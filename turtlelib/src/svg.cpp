...
namespace turtlelib
{
    ...
    void Svg::draw_vector(double x1, double y1, double x2, double y2, std::string color, int stroke_width)
    {
        ...
        oss << "<line x1=\"" << svg_x1 << "\" x2=\"" << svg_x2 << "\" y1=\"" << svg_y1
                  ...
                  << "\" stroke-width=\"" << stroke_width << "\" marker-start=\"url(#Arrow1Sstart)\" />\n";
        svg_content += oss.str();
    }

    void Svg::draw_frame(const Transform2D & t, const std::string & name, int axis_length, int stroke_width)
    {
    ...
    {
        std::string result;
        result += "<svg width=\"8.500000in\" height=\"11.000000in\"  viewBox=\"0 0 816.000000 1056.000000\" xmlns=\"http://www.w3.org/2000/svg\">\n";
