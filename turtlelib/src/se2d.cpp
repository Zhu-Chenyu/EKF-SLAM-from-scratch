...
namespace turtlelib
{
    ...
    Transform2D & Transform2D::operator*=(const Transform2D & rhs)
    {
        ...
        translation_.x = rotation_.x * rhs.translation_.x - rotation_.y * rhs.translation_.y + translation_.x;
        translation_.y = rotation_.y * rhs.translation_.x + rotation_.x * rhs.translation_.y + translation_.y;
