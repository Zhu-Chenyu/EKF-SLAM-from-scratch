...
class NuSimulator : public rclcpp::Node
{
  public:
    ...
    : Node("nusimulator")
    {
      ...
      wall_marker_pub_ = this->create_publisher<visualization_msgs::msg::MarkerArray>("~/real_walls", qos);
      ...
      obs_marker_pub_ = this->create_publisher<visualization_msgs::msg::MarkerArray>("~/real_obstacles", qos);
